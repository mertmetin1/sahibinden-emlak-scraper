...
export const LISTING_FILTER_CHIP_LABELS: Record<ListingFilterKey, string> = {
    search: 'Arama',
    province: 'İl',
    district: 'İlçe',
    ...
    insideSite: 'Site',
    creditEligible: 'Kredi',
    exchangeEligible: 'Takas',
    siteName: 'Site adı',
    firstSeenFrom: 'İlk görülme',
    lastSeenBefore: 'Son görülme',
    priceChanged: 'Fiyat değişimi',
    scanId: 'Tarama',
    status: 'Durum',
};
